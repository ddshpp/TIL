...
요새 진짜 머리가 잘 안돌아가고 답답하고 그랬다
답답해도 손놓을수는 없으니 문제는 계속품
하지만 발전이 잘 되는건가? 하는상태라고 보면된다
...
<a href="https://ibb.co/p1Q1PbP"><img src="https://i.ibb.co/XWDW4j4/0305-1.png" alt="0305-1" border="0"></a>
<a href="https://ibb.co/YW2D61Z"><img src="https://i.ibb.co/b31HxCJ/0305-2.png" alt="0305-2" border="0"></a>

여담으로 문제를 보는순간 언젠가 비슷한 문제를 푼거같아 참고할겸 찾아봤지만 찾지못했다. <br>
뭐 언젠간 찾겠지...

---

## 과정요약 - 너무너무 풀고싶었던 나의 흔적...
<a href="https://ibb.co/9nHk0z3"><img src="https://i.ibb.co/gyZL8HF/0305-3.png" alt="0305-3" border="0"></a>

```
과정을 최대한 요약해보겠다

1. 처음부터 끝까지, 풀이방법(아이디어)는 같음 (범위를 좁혀가며 정답을 찾자!)

2. 예시케이스는 맞더라도 임의의 입력에서는 틀린결과가 나와서 고생함
3. 0으로 나눠 오류가 나는 상황이 생길수있음을 인지함

4. 범위는 좁힌다쳐도 코드가 깔끔하지 못해 고생함
5. 범위를 좁힌다음 결국 정답을 구해야하는데, 이 과정에서 굉장히 고민함

5. 중간쯤 쓰였던 변수들을 int->long 으로 바꿈 (문제를 잘 읽어보면 이해가 간다)
6. 어? 그럼 저번에 제출한거 long으로 바꿔볼까? 
7. 정답 

아래는 깃헙에도 올렸지만 그대로 정답코드를 가져와보겠다
```
